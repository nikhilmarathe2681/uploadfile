...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		if($image_file)
		{
			if($type=="pdf/doc" || $type=='pdf/doc' || $type=='pdf/doc' || $type=='pdf/doc') //check file extension
			{	
			...
			{
				$errorMsg="Upload JPG, JPEG, Pdf & GIF File Formate.....CHECK FILE EXTENSION"; //error message file extension
			}
		}
		else
		{
